...
const HEADER_ROW = [
  DEFAULT_IMPORT_COLUMNS.lastName[0],
  DEFAULT_IMPORT_COLUMNS.firstName[0],
  DEFAULT_IMPORT_COLUMNS.gender[0],
  DEFAULT_IMPORT_COLUMNS.age[0],
  'Date of birth',
  'Session location',
  DEFAULT_IMPORT_COLUMNS.sessionName[0],
  DEFAULT_IMPORT_COLUMNS.selections[0],
  DEFAULT_IMPORT_COLUMNS.specialRequest[0],
  DEFAULT_IMPORT_COLUMNS.medicalIssues[0],
  DEFAULT_IMPORT_COLUMNS.photo[0],
  DEFAULT_IMPORT_COLUMNS.tshirtSize[0],
  DEFAULT_IMPORT_COLUMNS.primaryName[0],
  DEFAULT_IMPORT_COLUMNS.primaryHomePhone[0],
  DEFAULT_IMPORT_COLUMNS.primaryCellPhone[0],
  DEFAULT_IMPORT_COLUMNS.secondaryName[0],
  DEFAULT_IMPORT_COLUMNS.secondaryCellPhone[0],
  DEFAULT_IMPORT_COLUMNS.emergencyName[0],
  DEFAULT_IMPORT_COLUMNS.emergencyPhone[0],
  "Participant: Doctor's Name",
  "Participant: Doctor's phone number?",
  DEFAULT_IMPORT_COLUMNS.custody[0],
  'Waivers',
];
